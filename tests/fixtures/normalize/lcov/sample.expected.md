lcov: 68.57% lines covered, 288/420 in 3 files

| severity | file | line | code | detail |
| --- | --- | --- | --- | --- |
| error | src/lib/parse.js | - | lines | 96/200 lines covered (48.00%) |
| warning | src/ui/table.js | - | lines | 78/100 lines covered (78.00%) |
